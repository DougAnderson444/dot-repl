...
struct SvgAttrs {
    ...
    // For markers (arrows) and clipping
...
fn collect_attrs(node: Node) -> SvgAttrs {
    ...
    for a in node.attributes() {
        ...
        match (ns, local) {
            ...
            (None, "fill-rule") => sa.fill_rule = Some(value),
            ...
            (None, "stroke-linecap") => sa.stroke_linecap = Some(value),
            (None, "stroke-linejoin") => sa.stroke_linejoin = Some(value),
            (None, "stroke-miterlimit") => sa.stroke_miterlimit = Some(value),
            (None, "opacity") => sa.opacity = Some(value),
            ...
            (None, "marker-start") => sa.marker_start = Some(value),
            (None, "marker-mid") => sa.marker_mid = Some(value),
            (None, "marker-end") => sa.marker_end = Some(value),
            (None, "clip-path") => sa.clip_path = Some(value),
    ...
    let el = match tag {
        ...
        "polyline" => rsx! {
            polyline {
                ...
                fill: attrs.fill,
                "fill-opacity": attrs.fill_opacity,
                "fill-rule": attrs.fill_rule,
                stroke: attrs.stroke,
                "stroke-width": attrs.stroke_width,
                "stroke-dasharray": attrs.stroke_dasharray,
                "stroke-opacity": attrs.stroke_opacity,
                "stroke-linecap": attrs.stroke_linecap,
                "stroke-linejoin": attrs.stroke_linejoin,
                "stroke-miterlimit": attrs.stroke_miterlimit,
                opacity: attrs.opacity,
                "marker-start": attrs.marker_start,
                "marker-mid": attrs.marker_mid,
                "marker-end": attrs.marker_end,
                "clip-path": attrs.clip_path,
                style: attrs.style,
            }
        },
...
fn default_path(attrs: &SvgAttrs) -> Element {
    rsx! {
        path {
            ...
            "fill-rule": attrs.fill_rule.clone(),
            ...
            "stroke-linecap": attrs.stroke_linecap.clone(),
            "stroke-linejoin": attrs.stroke_linejoin.clone(),
            "stroke-miterlimit": attrs.stroke_miterlimit.clone(),
            opacity: attrs.opacity.clone(),
            "marker-start": attrs.marker_start.clone(),
            "marker-mid": attrs.marker_mid.clone(),
            "marker-end": attrs.marker_end.clone(),
            "clip-path": attrs.clip_path.clone(),
