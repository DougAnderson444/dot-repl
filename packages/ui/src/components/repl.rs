    ...
    rsx! {
        div {
            ...
            div {
                ...
                div {
                    class: "flex-1 overflow-auto p-4 bg-white",
                    DotDisplay {
                        dot: dot_input()
                    }
                }
                // Common chat panel container
                div {
                    class: "absolute bottom-0 left-0 w-full bg-gray-50 border-t border-gray-200 p-2 flex items-center",
                    // Expanded: show chat input and collapse/send buttons
                    input {
                    ...
                    button {
                        ...
                        onclick: move |_| {
                            // You can handle sending the chat message here
